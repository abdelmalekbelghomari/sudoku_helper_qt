...
#include <memory>
#include "../../Sudoku_Helper/ConfigurationManager.h"
...
QT_MOC_LITERAL(1, 21, 19), // "musicEnabledChanged"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 7), // "enabled"
QT_MOC_LITERAL(4, 50, 17), // "soundLevelChanged"
QT_MOC_LITERAL(5, 68, 5), // "level"
QT_MOC_LITERAL(6, 74, 15), // "languageChanged"
QT_MOC_LITERAL(7, 90, 8) // "language"

    },
    "ConfigurationManager\0musicEnabledChanged\0"
    "\0enabled\0soundLevelChanged\0level\0"
    "languageChanged\0language"
};
...
void ConfigurationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->musicEnabledChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->soundLevelChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ConfigurationManager::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigurationManager::musicEnabledChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ConfigurationManager::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigurationManager::soundLevelChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConfigurationManager::languageChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void ConfigurationManager::musicEnabledChanged(bool _t1)
{
...
// SIGNAL 1
void ConfigurationManager::soundLevelChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void ConfigurationManager::languageChanged(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
