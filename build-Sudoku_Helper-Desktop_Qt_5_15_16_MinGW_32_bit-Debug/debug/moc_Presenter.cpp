...
#include <memory>
#include "../../Sudoku_Helper/Presenter.h"
...
QT_MOC_LITERAL(1, 10, 12), // "gridSelected"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5) // "index"

    },
    "Presenter\0gridSelected\0\0index"
};
...
void Presenter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->gridSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Presenter::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Presenter::gridSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Presenter::gridSelected(int _t1)
{
